...
def perception_step(Rover):
    ...
    Rover.vision_image[:,:,0] = colorsel_obstacle
    ...
    if (Rover.pitch < 0.5) & (Rover.roll < 0.5):
    ...
    obst_distances, obst_angles = to_polar_coords(obstacle_xpix, obstacle_ypix)
    Rover.obst_dists = obst_distances
